...
class HuffmanCoding:
    ...
    def decompress(self, compressedfile):
        ...
        write = open(filename_split[0] + ".txt", 'w')
...
if __name__ == '__main__':
    paht, out= "a.txt", "a_c.bin"
    huffman.compress(paht)
    huffman.decompress(out)
